...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51' => 'get10396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51Service',
            '2_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51' => 'get20396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51Service',
        ...
        $this->privates = array(
            '1_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51' => true,
            '2_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51']) ? $this->services['1_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51'] : $this->get10396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51']) ? $this->services['2_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51'] : $this->get20396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f91e47ffaa8056fafa92465ba308820f07aec76a66b48b12251c4adfdd298b79');
    ...
    /**
     * Gets the '1_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get10396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51Service()
    {
        return $this->services['1_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get20396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51Service()
    {
        return $this->services['2_0396b0fa2f31654592983d5ba9d1f141e1de6105419d5462288f57507f73ba51'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5ME2Y+GRqp', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JEVA7s84Ra', 0, 'd26ZN3yds7clODGdgLvmfa', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fcdPmlkhoD', 0, 'd26ZN3yds7clODGdgLvmfa', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8+-nDek2-i', 0, 'd26ZN3yds7clODGdgLvmfa', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59cbc6de1e1a00.75168872');
    }
